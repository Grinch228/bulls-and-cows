...
CTEST(checkers, cows_counter_guess_0) {
...
CTEST(checkers, cows_counter_guess_1) {
    int arr2[4] = {4,6,7,8}, arr1[4] = {1,2,3,4};
    int result = cows_counter(arr1, arr2);
    int expect = 1;
    ASSERT_EQUAL(expect, result);
}
CTEST(checkers, cows_counter_guess_2) {
    int arr2[4] = {4,3,7,8}, arr1[4] = {1,2,3,4};
    int result = cows_counter(arr1, arr2);
    int expect = 2;
    ASSERT_EQUAL(expect, result);
}
CTEST(checkers, cows_counter_guess_3) {
    int arr2[4] = {4,3,2,8}, arr1[4] = {1,2,3,4};
    int result = cows_counter(arr1, arr2);
    int expect = 3;
    ASSERT_EQUAL(expect, result);
}
CTEST(checkers, cows_counter_guess_4) {
